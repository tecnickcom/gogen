...
func TestStats(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name:    "Three elements",
			data:    []int{13, 37, 29},
			want:    &DescStats[int]{Count: 3, Entropy: 1.0200, ExKurtosis: 0, Max: 37, MaxID: 1, Mean: 26.3333, MeanDev: 8.8889, Median: 29, Min: 13, MinID: 0, Mode: 13, ModeFreq: 1, Range: 24, Skewness: -0.9352, StdDev: 12.2202, Sum: 79, Variance: 149.3333},
			wantErr: false,
		},
		{
			name:    "Four elements",
		...
		},
		{
			...
			want:    &DescStats[int]{Count: 12, Entropy: 2.3019, ExKurtosis: -1.9100, Max: 83, MaxID: 1, Mean: 50.5, MeanDev: 26.8333, Median: 45, Min: 13, MinID: 2, Mode: 83, ModeFreq: 4, Range: 70, Skewness: -0.0494, StdDev: 30.2850, Sum: 606, Variance: 917.1818},
			wantErr: false,
		},
		{
			name:    "Mode not in last sorted run",
			data:    []int{13, 13, 13, 83},
			want:    &DescStats[int]{Count: 4, Entropy: 0.9778, ExKurtosis: 4, Max: 83, MaxID: 3, Mean: 30.5, MeanDev: 26.25, Median: 13, Min: 13, MinID: 0, Mode: 13, ModeFreq: 3, Range: 70, Skewness: 2, StdDev: 35, Sum: 122, Variance: 1225},
			wantErr: false,
		},
	}
