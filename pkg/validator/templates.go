...
func ErrorTemplates() map[string]string {
	return map[string]string{ //nolint:gosec
		...
		"bcp47_strict_language_tag":     `{{.Namespace}} must be a valid strict BCP 47 language tag`,
		...
		"mimetype":                      `{{.Namespace}} must be a file of MIME type {{.Param}}`,
		...
		"noneof":                        `{{.Namespace}} must not be one of {{.Param}}`,
		"noneofci":                      `{{.Namespace}} must not be one of {{.Param}} (case insensitive)`,
		...
		"origin":                        `{{.Namespace}} must be a valid origin`,
